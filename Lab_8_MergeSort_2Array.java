...
//Execute the merge algorithm with the following two arrays and justify the output obtained in each case.

//Java program to merge k sorted arrays of size n each.

class Lab_8_MergeSort_2Array {
...
//Driver program to test above functions
	public static void main(String[] args) {
		...
		// in an array
		// { 2, 6, 8, 9, 1, 5, 9, 11 }, { 8, 6, 2, 9, 1, 5, 11, 9 }
