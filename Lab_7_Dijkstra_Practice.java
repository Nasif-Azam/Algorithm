...
//		 sptSet[i] will true if vertex i is included in shortest path tree or shortest distance from src to i is finalized
		...
		for (int count = 0; count < V - 1; count++) { // Pick the minimum distance vertex from the set of vertices not
														// yet processed.
...
//		int graph[][] = new int[][] { { 0, 10, 5, 0, 0 }, { 0, 0, 2, 1, 0 }, { 0, 3, 0, 9, 2 }, { 0, 0, 0, 0, 4 },
//				{ 7, 0, 0, 6, 0 } };
//		int graph[][]=new int [][] {
//			{0,0,0,0,4},
//			{10,0,0,3,0},
...
//		};
		...
		Lab_7_Dijkstra_Practice Dij = new Lab_7_Dijkstra_Practice();
